...
extern void GPIOPJ_Handler ( void );
extern void GPIOPN_Handler ( void );
...
const intvec_elem __vector_table[] =
{
  ...
  0,
  0,
  GPIOPJ_Handler, //Vector67, intrp51
  0,
  0,
  0,
  0,
  ...
  0,
  0,
  GPIOPN_Handler //Vector num 89, intrp#73
};
...
#pragma call_graph_root = "interrupt"
__weak void GPIOPJ_Handler ( void ) { while(1) {} }
#pragma call_graph_root = "interrupt"
__weak void GPIOPN_Handler ( void ) { while(1) {} }
#pragma call_graph_root = "interrupt"
